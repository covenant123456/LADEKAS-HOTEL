...
<body>
	...
	<div class="banner-top">
		...
		<div class="contact-bnr-w3-agile">
			<ul>
				<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@LADEKAS.COM</a></li>
				<li><i class="fa fa-phone" aria-hidden="true"></i>+234(0)9063774525</li>
				<li class="s-bar">
					<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">LADEKAS <span>HOTEL</span>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">LADEKAS HOTEL</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
	...
	<div class="about-wthree" id="about">
		<div class="container">
			<div class="ab-w3l-spa">
				<h3 class="title-w3-agileits title-black-wthree">About LADEKAS HOTEL</h3>
	...
	<section class="contact-w3ls" id="contact">
		<div class="container">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
				...
				<p class="contact-agile1"><strong>Phone :</strong>+234(0)9063774525</p>
				<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@LADEKASHOTEL.COM</a></p>
				<p class="contact-agile1"><strong>Address :</strong> Koto Ogede Akinmorin Oyo State</p>
				...
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d252987.80995530204!2d3.6560993867187546!3d7.796756599999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1037591670917983%3A0x70c395f8fd4ac044!2sLadekas%20Golden%20Sea%20Hotels%20and%20Suites!5e0!3m2!1sen!2sng!4v1721817270855!5m2!1sen!2sng" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
				</div>
			<div class="clearfix"></div>
		</div>
	</section>
