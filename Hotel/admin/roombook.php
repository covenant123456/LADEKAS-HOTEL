			...
			<div id="page-inner">
				...
				<div class="row">
					...
					while ($crow = mysqli_fetch_array($cre)) {
						...
						if ($cs == "Exclusive Room") {
							$csr = $csr + 1;
						}
						if ($cs == "Executive Room") {
							$cdr = $cdr + 1;
						}
					}
...
if (isset($_POST['co'])) {
	...
	if ($st == "Confirmed") {
		...
		if ($f1 == "NO") {
			echo "<script type='text/javascript'> alert('Sorry! Not Available Economic Room ')</script>";
		} else if ($f2 == "NO") {
			echo "<script type='text/javascript'> alert('Sorry! Not Available  Kings Room')</script>";
		} else if ($f3 == "NO") {
			echo "<script type='text/javascript'> alert('Sorry! Not Available Exclusive Room')</script>";
		} else if ($f4 == "NO") {
			echo "<script type='text/javascript'> alert('Sorry! Not Available Executive Room')</script>";
		} else if (mysqli_query($con, $urb)) {
			echo "<script type='text/javascript'> alert('Guest Room booking is confirmed')</script>";
			//echo "<script type='text/javascript'> window.location='home.php'</script>";
			$type_of_room = 0;
			if ($troom == "Economic Room") {
				$type_of_room = 7000;
			} else if ($troom == "Kings Room") {
				$type_of_room = 10000;
			} else if ($troom == "Exclusive Room") {
				$type_of_room = 15000;
			} else if ($troom == "Executive Room") {
				$type_of_room = 25000;
			}
			...
			} else if ($meal == "Dinner Only") {
				$type_of_meal = $type_of_bed * 2;
			} else if ($meal == "Breakfast Only") {
				$type_of_meal = $type_of_bed * 2;
			} else if ($meal == "Brunch Only") {
				$type_of_meal = $type_of_bed * 2;
			} else if ($meal == "Full Package") {
